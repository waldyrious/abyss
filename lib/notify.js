...
if (secret.gcmapikey) {
	console.log("Google Cloud Messaging API key found, Chrome notifications will be sent.");
	chromeNotifications = true;
	gcmapikey = secret.gcmapikey;
} else {
	console.log("Google Cloud Messaging API key not present in secret.json, Chrome notifications will not be sent.");
